...
public class LOTRGuiBanner extends LOTRGuiScreenBase {
	...
	public void drawScreen(int i, int j, float f) {
		...
		if (defaultPermissionsOpen) {
			...
			String boxSubtitle = StatCollector.translateToLocalFormatted("lotr.gui.bannerEdit.perms.allPlayers", new Object[0]);
			Function<LOTRBannerProtection.Permission, Boolean> getEnabled = new Function<LOTRBannerProtection.Permission, Boolean>() {
	...
	public void updateScreen() {
		...
		if (alignmentField.getVisible() && !alignmentField.isFocused()) {
			...
			try {
				alignment = Float.parseFloat(alignmentField.getText());
